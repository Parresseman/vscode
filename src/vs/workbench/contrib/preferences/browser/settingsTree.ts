...
export function updateSettingTreeTabOrder(): void {
	const allRows = [...document.querySelectorAll(AbstractSettingRenderer.ALL_ROWS_SELECTOR)];
...
export abstract class AbstractSettingRenderer extends Disposable implements ITreeRenderer<SettingsTreeElement, never, any> {
	...
	static readonly ALL_ROWS_SELECTOR = '.settings-tree-container .monaco-list-row';
